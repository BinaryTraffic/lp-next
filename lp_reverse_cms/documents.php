...
<body>
  ...
  <p class="muted">Markdown（.md）は環境によってはブラウザで平文表示になります。レイアウト付きは .html を開いてください。</p>
  <ul>
    <li><a href="<?= $d('PROJECT_HISTORY_AND_SETUP.md') ?>">PROJECT_HISTORY_AND_SETUP.md</a> — 経緯・ゼロからの構築手順</li>
